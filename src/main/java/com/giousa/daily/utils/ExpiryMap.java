...
public class ExpiryMap<K, V> extends HashMap<K, V> {
     ...
     */
//    private long EXPIRY = 1000 * 60 * 60 * 2;
//    private long EXPIRY = 1000 * 60 * 50 * 2;
//    private long EXPIRY = 2592000;
    ...
    private ExpiryMap(long defaultExpiryTime){
        this(1 << 4, defaultExpiryTime);
    }
    private ExpiryMap(int initialCapacity, long defaultExpiryTime){
...
//        map.put("test3", "ankang33", 1000 * 60 * 50 * 2);
...
//        }
        ...
        try {
            String nickname = URLEncoder.encode("不笑猫", "UTF-8");
